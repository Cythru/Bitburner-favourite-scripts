...
export async function main(ns) {
  ...
  ns.print("  ┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄");
  ns.print("");
  ns.print("  [ NOTE: The following is a matter of historical record. ]");
  ns.print("  [ It was not a secret. Everyone in the operation knew.  ]");
  ns.print("");
  await ns.sleep(1200);
  ns.print("  The council had forty-one operatives with the clearance");
  ns.print("  and the training to take the TIER ZERO teleporter room.");
  ns.print("  Forty of them were rejected in the first meeting.");
  ns.print("");
  await ns.sleep(1400);
  ns.print("  Because Abraham had a known vulnerability.");
  ns.print("  Documented. Filed. Assessed as tactically exploitable.");
  ns.print("  He had raised his little sister from the age of nine.");
  ns.print("  He had never once in his life been able to move against her.");
  ns.print("  Not in training. Not in the field. Not anywhere.");
  ns.print("");
  await ns.sleep(1400);
  ns.print("  She was also his first and only chosen successor.");
  ns.print("  Publicly named. On record.");
  ns.print("  The one he believed in above everyone else he had ever trained.");
  ns.print("  He had said so, more than once, without embarrassment:");
  ns.print("  that she was the best thing he had ever made.");
  ns.print("  That whatever came after him, she would carry it correctly.");
  ns.print("  That he had no doubt.");
  ns.print("");
  await ns.sleep(1800);
  ns.print("  The council sent his successor to end him.");
  ns.print("  The person he was proudest of.");
  ns.print("  The one he had chosen to carry everything he believed.");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  Every simulation said the same thing:");
  ns.print("  send her, and he would hesitate.");
  ns.print("  send her, and they would have the room.");
  ns.print("");
  await ns.sleep(2000);
  ns.print("  She knew.");
  ns.print("  She had read the file.");
  ns.print("  She had read the part where he named her.");
  ns.print("  She accepted the mission anyway.");
  ns.print("");
  await ns.sleep(1400);
  ns.print("  The plan worked.");
  ns.print("  He hesitated. She got the room.");
  ns.print("  Every simulation had called it correctly.");
  ns.print("");
  await ns.sleep(1200);
  ns.print("  What no simulation had accounted for");
  ns.print("  was what he would do instead of fighting.");
  ns.print("  The models had only ever asked: will he hesitate?");
  ns.print("  None of them had thought to ask: what does he say?");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  That part — what it cost her to accept it,");
  ns.print("  and what it cost the plan when he opened his mouth —");
  ns.print("  was not in any file.");
  ns.print("");
  await ns.sleep(1400);
  ns.print("  She had been chosen to carry everything he believed.");
  ns.print("  She had taken a mission to end the man who chose her.");
  ns.print("  She had stood in that room.");
  ns.print("  She had watched his face when he let his hand fall from the override.");
  ns.print("  She had heard him call her a start.");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  The succession had not failed because she was not ready.");
  ns.print("  It had failed because she had been used as the instrument of its destruction.");
  ns.print("  And she had let it happen.");
  ns.print("  And she would have to carry that");
  ns.print("  in exactly the same hands he had always said were the right ones.");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  ┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄");
  ns.print("");
  ...
  ns.print("");
  await ns.sleep(1600);
  ns.print("  He had trained for this room for eleven years.");
  ns.print("  He knew every angle. Every blind spot.");
  ns.print("  He had the higher ground from the doorway.");
  ns.print("  He had the clearance override on his wrist.");
  ns.print("  He could have ended it in four seconds.");
  ns.print("  The analysts had war-gamed it. Four seconds.");
  ns.print("");
  await ns.sleep(1800);
  ns.print("  He stood in the doorway for eight.");
  ns.print("");
  await ns.sleep(1200);
  ns.print("  Because she was standing the way she used to stand");
  ns.print("  when she was seven years old and concentrating on something.");
  ns.print("  Shoulders up. Head slightly forward.");
  ns.print("  He had watched her stand like that a thousand times.");
  ns.print("  Over homework. Over broken things she was trying to fix.");
  ns.print("  He had stood behind her then too,");
  ns.print("  trying to decide whether to help or let her figure it out.");
  ns.print("");
  await ns.sleep(2000);
  ns.print("  He thought of every room he had watched her walk into.");
  ns.print("  Every time he had told someone: that one.");
  ns.print("  That is the one who will do what I could not.");
  ns.print("  That is the one I trust with all of it.");
  ns.print("");
  await ns.sleep(1800);
  ns.print("  He did not say any of it.");
  ns.print("  Not yet.");
  ns.print("  It sat in the doorway with him.");
  ns.print("  Every word of it.");
  ns.print("  Unsayable.");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  He let his hand fall from the override.");
  ns.print("");
  await ns.sleep(1000);
  ns.print("  He couldn't.");
  ns.print("  He had raised her.");
  ns.print("  He had chosen her.");
  ns.print("  He could not.");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  He stepped into the room.");
  ns.print("");
  await ns.sleep(900);
  ns.print("  She turned.");
  ns.print("  She had heard him come in.");
  ns.print("  Of course she had.");
  ns.print("");
  await ns.sleep(1000);
  ns.print("  Her eyes went to his wrist first.");
  ns.print("  Then to the doorway angle.");
  ns.print("  Then back to him.");
  ns.print("");
  await ns.sleep(1200);
  ns.print("  She understood the geometry immediately.");
  ns.print("  She had been trained by the same people.");
  ns.print("  She knew what he'd had.");
  ns.print("  She knew what he hadn't used.");
  ns.print("");
  await ns.sleep(1400);
  ns.print("  Something moved behind her eyes.");
  ns.print("  She didn't name it.");
  ns.print("  Neither did he.");
  ns.print("");
  await ns.sleep(1200);
  ...
  ns.print("");
  await ns.sleep(800);
  ns.print("  She kept talking.");
  ns.print("  He heard her.");
  ns.print("  He also heard everything else.");
  ns.print("");
  await ns.sleep(1200);
  ns.print("  The storm moved through him.");
  ns.print("  Wordless. All of it at once.");
  ns.print("  What he had believed she would become.");
  ns.print("  What he had told people, privately, she already was.");
  ns.print("  Every moment he had stepped back and let her lead");
  ns.print("  because he thought: she is ready.");
  ns.print("  She is more than ready.");
  ns.print("  I chose correctly.");
  ns.print("");
  await ns.sleep(1800);
  ns.print("  And now here.");
  ns.print("  And now this.");
  ns.print("  And he had no one to blame for it but the people");
  ns.print("  who had looked at everything he built in her");
  ns.print("  and decided it was a lever.");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  The storm passed.");
  ns.print("  He let it.");
  ns.print("  He did not say a word of it.");
  ns.print("  It was his. Not hers to carry.");
  ns.print("");
  await ns.sleep(1400);
  ...
  ns.print("");
  await ns.sleep(700);
  ns.print("  ❝ You had the override. ❞");
  ns.print("");
  await ns.sleep(600);
  ns.print("  Not a question.");
  ns.print("  Not an accusation.");
  ns.print("  Just the fact, laid flat.");
  ns.print("  She had been carrying it since he walked in.");
  ns.print("");
  await ns.sleep(1400);
  ...
  ns.print("");
  await ns.sleep(1000);
  ns.print("  Four others stood with her. Immediately.");
  ns.print("  Without looking at each other.");
  ns.print("");
  await ns.sleep(900);
  ns.print("  The remaining twelve did not move.");
  ns.print("  Not because they disagreed.");
  ns.print("  Because they had no words.");
  ns.print("  Some of them had been in that room for twenty years.");
  ns.print("  They had heard a lot of final statements.");
  ns.print("  They had never heard anything like that.");
  ns.print("  Their hands were still.");
  ns.print("  Their mouths were still.");
  ns.print("  They just watched the feed.");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  Five hands moved.");
  ns.print("  Five channels opened.");
  ...
  ns.print("");
  await ns.sleep(1200);
  ns.print("  Three of her people were waiting in the corridor.");
  ns.print("  They had been watching on the secondary feed.");
  ns.print("");
  await ns.sleep(900);
  ns.print("  The first one smiled.");
  ns.print("");
  await ns.sleep(600);
  ns.print("  ❝ Congratulations. We knew you'd get him. ❞");
  ns.print("");
  await ns.sleep(800);
  ns.print("  ❝ Honestly? Once he came in without using the override");
  ns.print("    it was obvious. Classic Abraham — always too soft. ❞");
  ns.print("");
  await ns.sleep(1200);
  ns.print("  She stopped walking.");
  ns.print("");
  await ns.sleep(700);
  ns.print("  She looked at him.");
  ns.print("");
  await ns.sleep(800);
  ns.print("  The look she gave him was the kind that makes a person");
  ns.print("  suddenly aware of how much they don't understand.");
  ns.print("  Slow. Flat. Like watching something she'd already");
  ns.print("  decided wasn't worth explaining.");
  ns.print("");
  await ns.sleep(1600);
  ns.print("  She did not correct him.");
  ns.print("  She could not have found the words.");
  ns.print("  And he would not have deserved them anyway.");
  ns.print("");
  await ns.sleep(1400);
  ns.print("  She kept walking.");
  ns.print("");
  await ns.sleep(1000);
